# fiShip — Source brief (verbatim from upstream `CLAUDE.md`)

This file preserves the captain-facing project brief from the `fiShip`
codebase, unchanged. It is the source of truth for content rules, color
semantics, and the captain's UX constraints.
